	...
	<view class="wrap">
		...
		<view class="uni-flex line2">
			...
			<view class="uni-flex btn3">
				<view v-for="(item,i) in btn3Arr" :key="i" :class="{active:btn3_i==i,yellow1:onClose}" :data-i='i' @tap='changePriceType(i,item)'>{{item}}
				</view>
			</view>
		</view>
		...
		<mpvue-checkbox themeColor="#007AFF" ref="typeCheckbox" :pickerValueDefault="[0]" @onConfirm="onConfirms" @onCancel="onCancel"
