      ...
      <div class="self-mask" v-if="isOpened > 0" v-show="show">
        <div class="area_ctrl">
          <div class="area_btn_box">
            <div class="area_btn larea_cancel" v-if="false" v-vtap="{method:close}">取消</div>
            <div class="area_btn larea_finish" v-vtap="{method:finish}">确定</div>
          </div>
          <div class="area_roll_mask">
            <div class="area_roll">
              <div>
                <div top="0" ref="province" class="gear area_province" data-areatype="area_province" data-type="provs" :data-len="(pData1 && pData1.length) ? pData1.length : 0" val="5" @touchstart="gearTouchStart" @touchmove="gearTouchMove" @touchend="gearTouchEnd">
              ...
              <div v-if="columns > 1">
                <div class="gear area_city" top="0" ref="city" data-areatype="area_city" data-type="city" :data-len="(pData2 && pData2.length) ? pData2.length : 0" @touchstart="gearTouchStart" @touchmove="gearTouchMove" @touchend="gearTouchEnd" val="5">
              ...
              <div v-if="columns > 2">
                <div class="gear
                  area_county" top="0" ref="county" data-areatype="area_county" :data-len="(pData3 && pData3.length) ? pData3.length : 0" @touchstart="gearTouchStart" @touchmove="gearTouchMove" @touchend="gearTouchEnd" val="5">
      ...
      setTimeout(() => {
        if (!this.link) {
          ...
          if (type === 'provs') {
            ...
            this.getcitylist(0, this.pData1[endVal].value, endVal)
            if (this.columns === 3) {
              this.resetData3(0)
            }
          }
