<!--<template>-->
  <!--<div class="wrap">-->
    ...
    <!--<mpvue-picker-->
      ...
      <!--:pickerValueDefault="[0]"-->
      <!--@onConfirm="onConfirm"-->
      <!--@pick-change="pickChange"-->
      <!--@onCancel="onCancel"-->
      <!--:picker-value-array="pickerCityValueArray"-->
    <!--&gt;</mpvue-picker>-->
    <!--<mpvue-picker-->
      <!--themeColor="#007AFF"-->
      <!--ref="subBankPick"-->
      ...
      <!--@onConfirm="onConfirm"-->
      <!--@onCancel="onCancel"-->
      <!--:picker-value-array="pickerSubBankArray"-->
    <!--&gt;</mpvue-picker>-->
  <!--</div>-->
<!--</template>-->
  ...
  <div class="wrap">
    ...
    <div class="list-row">
      ...
      <div class="chooseCount">
        ...
        <!--<van-picker :columns="columns" @change="onChange" style="z-index: 1000" />-->
